...
<div class="jumbotron">
  <h3><?= __('Subida de Test') ?>
     <img class="mensajeInfo iconos" data-content="<?= __('Se deberá de subir un fichero .zip que contenga el test de extensión .java. Es importante que el test pertenezca al paquete establecido en la configuración de parámetros de la tarea. Se podrá actualizar el enunciado aunque no se suban test.') ?>" 
...
<script type="text/javascript">
	...
	$('#login_form').submit(function() {
		waitingDialog.show("Subiendo test. El proceso podría durar varios segundos.");
	});
